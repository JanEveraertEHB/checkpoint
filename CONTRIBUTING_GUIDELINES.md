...
As for everything else in the project, the contributions to Autodidact are governed by our code of condict.

## Using the issue tracker

First things first: **Do NOT report security vulnerabilities in public issues!** Please disclose responsibly by letting team know upfront. We will assess the issue as soon as possible on a best-effort basis and will give you an estimate for when we have a fix and release available for an eventual public disclosure.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/autodidacthq/<repo-name>
   ```
...
### For Members of the Autodidact Contributors Team

1. Clone the repo and create a branch

   ```bash
   git clone https://github.com/autodidacthq/<repo-name>
   cd <repo-name>
   git checkout -b <topic-branch-name>
   ```
...
Triaging is a great way to contribute to Autodidact without having to write code.
If you are interested, please [leave a comment here](https://github.com/janeveraertehb) asking to join the triaging team.
...
4. If there is anything you don’t like, leave a comment below the respective
   ...
   been addressed.
5. If you are not sure about something, mention `@autodidact/maintainers` or specific
